public extension VAST.Element {
    ...
    /// nodes.
    struct ClosedCaptionFiles {
        /// Individual closed caption files for various languages.
        public let closedCaptionFile: [ClosedCaptionFile]

        public init(closedCaptionFile: [ClosedCaptionFile]) {
            self.closedCaptionFile = closedCaptionFile
        }
    }
}
